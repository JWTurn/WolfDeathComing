...
par(mfrow = c(1,3))
hist(dat[wolfID %chin% dat.wnn.lastmo$wolfID & case_==TRUE, distance2 ])
hist(dat[wolfID %chin% dat.wnn.lastmo$wolfID & case_==TRUE, scale(distance2) ])
hist(dat[wolfID %chin% dat.wnn.lastmo$wolfID & case_==TRUE, log(distance2 + 1)])
...
road.CDV.1day.1 <- dat[wolfID %chin% dat.wnn.lastmo$wolfID,.(ToD_start = factor('day', levels = levels(ToD_start)),
                          ...
                          propopen_end_adj = mean(propopen_end_adj, na.rm = T),
                          propwet_end= mean(propwet_end, na.rm = T),
                          roadDist_end = seq(from = 0, to = 3000, by = 50),
                          distance2 = median(distance2, na.rm = T),
                          nnDist_end = median(nnDist_end, na.rm = T),
                          packDist_end = median(packDist_end, na.rm = T),
                          COD = factor('CDV', levels = levels(COD)),
...
h1.road.CDV.1day.indiv <- data.table(rbindlist(p.road.CDV.1day.1.indiv),
                                   ttd = '1 day', COD = 'CDV', var = 'road', x = seq(from = 0, to = 3000, by = 50))
...
h1.road.CDV.60day.indiv <- data.table(rbindlist(p.road.CDV.60day.1.indiv),
                                    ttd = '60 days', COD = 'CDV', var = 'road', x = seq(from = 0, to = 3000, by = 50))
...
h1.road.human.1day.indiv <- data.table(rbindlist(p.road.human.1day.1.indiv),
                                     ttd = '1 day', COD = 'human', var = 'road', x = seq(from = 0, to = 3000, by = 50))
...
h1.road.human.60day.indiv <- data.table(rbindlist(p.road.human.60day.1.indiv),
                                      ttd = '60 days', COD = 'human', var = 'road', x = seq(from = 0, to = 3000, by = 50))
...
h1.road.control.1day.indiv <- data.table(rbindlist(p.road.control.1day.1.indiv),
                                       ttd = '1 day', COD = 'control', var = 'road', x = seq(from = 0, to = 3000, by = 50))
...
h1.road.control.60day.indiv <- data.table(rbindlist(p.road.control.60day.1.indiv),
                                        ttd = '60 days', COD = 'control', var = 'road', x = seq(from = 0, to = 3000, by = 50))
...
nn.CDV.1day.1 <- dat[wolfID %chin% dat.wnn.lastmo$wolfID,.(pop = factor('GHA26', levels = levels(pop)), ToD_start = factor('day', levels = levels(ToD_start)),
                                                           ...
                                                           propwet_end= mean(propwet_end, na.rm = T),  
                                                           roadDist_end = median(roadDist_end, na.rm = T),
                                                             distance2 = seq(from = 0, to = 7500, by = 50),
                                                           nnDist_end = seq(from = 0, to = 7500, by = 50),
                                                             packDist_end = median(packDist_end, na.rm = T),
                                                             COD = factor('CDV', levels = levels(COD)),
                                                             ttd1 = 1,
                                                             wolf_step_id = NA, wolfID = NA)]
...
logRSS.nn <- data.frame(COD= 'CDV', ttd = '1 day', var = 'nn', rss = logRSS.nn.CDV.1day, x = seq(from = 0, to = 7500, by = 50))
logRSS.nn <- rbind(logRSS.nn, data.frame(COD= 'CDV', ttd = '60 days', var = 'nn', rss = logRSS.nn.CDV.60day, x = seq(from = 0, to = 7500, by = 50)))
...
h1.nn.CDV.1day.indiv <- data.table(rbindlist(p.nn.CDV.1day.1.indiv),
            ttd = '1 day', COD = 'CDV', var = 'nn', x = seq(from = 0, to = 7500, by = 50))
...
h1.nn.CDV.60day.indiv <- data.table(rbindlist(p.nn.CDV.60day.1.indiv),
                                   ttd = '60 days', COD = 'CDV', var = 'nn', x = seq(from = 0, to = 7500, by = 50))
...
h1.nn.human.1day.indiv <- data.table(rbindlist(p.nn.human.1day.1.indiv),
                                   ttd = '1 day', COD = 'human', var = 'nn', x = seq(from = 0, to = 7500, by = 50))
...
h1.nn.human.60day.indiv <- data.table(rbindlist(p.nn.human.60day.1.indiv),
                                    ttd = '60 days', COD = 'human', var = 'nn', x = seq(from = 0, to = 7500, by = 50))
...
logRSS.nn <- rbind(logRSS.nn, data.frame(COD= 'control', ttd = '1 day', var = 'nn', rss = logRSS.nn.control.1day, x = seq(from = 0, to = 7500, by = 50)))
logRSS.nn <- rbind(logRSS.nn, data.frame(COD= 'control', ttd = '60 days', var = 'nn', rss = logRSS.nn.control.60day, x = seq(from = 0, to = 7500, by = 50)))
...
h1.nn.control.1day.indiv <- data.table(rbindlist(p.nn.control.1day.1.indiv),
                                   ttd = '1 day', COD = 'control', var = 'nn', x = seq(from = 0, to = 7500, by = 50))
...
h1.nn.control.60day.indiv <- data.table(rbindlist(p.nn.control.60day.1.indiv),
                                    ttd = '60 days', COD = 'control', var = 'nn', x = seq(from = 0, to = 7500, by = 50))
...
pack.CDV.1day.1 <- dat[wolfID %chin% dat.wnn.lastmo$wolfID,.(ToD_start = factor('day', levels = levels(ToD_start)),
                                                           ...
                                                           distance2 = median(distance2, na.rm = T),
                                                           nnDist_end = median(nnDist_end, na.rm = T),
                                                           packDist_end = seq(0, 15000, by = 50),
                                                           COD = factor('CDV', levels = levels(COD)),
                                                           ttd1 = 1,
                                                           wolf_step_id = NA, wolfID = NA)]
...
logRSS.nn <- rbind(logRSS.nn, data.frame(COD= 'CDV', ttd = '1 day', var = 'boundary', rss = logRSS.pack.CDV.1day, x = seq(from = 0, to = 15000, by = 50)))
logRSS.nn <- rbind(logRSS.nn, data.frame(COD= 'CDV', ttd = '60 days', var = 'boundary', rss = logRSS.pack.CDV.60day, x = seq(from = 0, to = 15000, by = 50)))
...
h1.pack.CDV.1day.indiv <- data.table(rbindlist(p.pack.CDV.1day.1.indiv),
                                   ttd = '1 day', COD = 'CDV', var = 'boundary', x = seq(from = 0, to = 15000, by = 50))
...
h1.pack.CDV.60day.indiv <- data.table(rbindlist(p.pack.CDV.60day.1.indiv),
                                    ttd = '60 days', COD = 'CDV', var = 'boundary', x = seq(from = 0, to = 15000, by = 50))
...
logRSS.nn <- rbind(logRSS.nn, data.frame(COD= 'human', ttd = '1 day', var = 'boundary', rss = logRSS.pack.human.1day, x = seq(from = 0, to = 15000, by = 50)))
logRSS.nn <- rbind(logRSS.nn, data.frame(COD= 'human', ttd = '60 days', var = 'boundary', rss = logRSS.pack.human.60day, x = seq(from = 0, to = 15000, by = 50)))
...
h1.pack.human.1day.indiv <- data.table(rbindlist(p.pack.human.1day.1.indiv),
                                     ttd = '1 day', COD = 'human', var = 'boundary', x = seq(from = 0, to = 15000, by = 50))
...
h1.pack.human.60day.indiv <- data.table(rbindlist(p.pack.human.60day.1.indiv),
                                      ttd = '60 days', COD = 'human', var = 'boundary', x = seq(from = 0, to = 15000, by = 50))
...
h1.pack.control.1day.indiv <- data.table(rbindlist(p.pack.control.1day.1.indiv),
                                       ttd = '1 day', COD = 'control', var = 'boundary', x = seq(from = 0, to = 15000, by = 50))
...
h1.pack.control.60day.indiv <- data.table(rbindlist(p.pack.control.60day.1.indiv),
                                        ttd = '60 days', COD = 'control', var = 'boundary', x = seq(from = 0, to = 15000, by = 50))
...
#saveRDS(logRSS.indiv, 'data/derived-data/logRSS_indiv_scaled.Rds')
...
nn.1.model.b <- ggplot(data=setDT(logRSS.indiv)[var == 'nn'& ttd=='1 day'], aes(x, rss, colour=COD)) +
  geom_line(aes(group = wolfID,alpha = .0001), linetype ='twodash', show.legend = F) +
  #geom_point(shape = 1, aes(alpha = .001), show.legend = F) +
  geom_smooth(size = 1.5, aes(fill = COD), method = 'loess') +
...
nn.60.model.b <- ggplot(data=setDT(logRSS.indiv)[var == 'nn'& ttd=='60 days'], aes(x, rss, colour=COD)) +
  geom_line(aes(group = wolfID,alpha = .0001), linetype ='twodash', show.legend = F) +
  #geom_point(shape = 1, aes(alpha = .001), show.legend = F) +
  geom_smooth(size = 1.5, aes(fill = COD), method = 'loess', show.legend = F) +
  # geom_line(data=logRSS.pop.model[var == 'nn'& ttd=='1 day'], aes(x, rss, colour=COD)) +
...
pack.1.model.b <- ggplot(data=setDT(logRSS.indiv)[var == 'boundary'& ttd=='1 day'], aes(x, rss, colour=COD)) +
  geom_line(aes(group = wolfID,alpha = .0001), linetype ='dashed', show.legend = F) +
  #geom_point(shape = 1, aes(alpha = .001), show.legend = F) +
  geom_smooth(size = 1.5, aes(fill = COD), method = 'loess') +
...
pack.60.model.b <- ggplot(data=setDT(logRSS.indiv)[var == 'boundary'& ttd=='60 days'], aes(x, rss, colour=COD)) +
  geom_line(aes(group = wolfID,alpha = .0001), linetype ='dashed', show.legend = F) +
  #geom_point(shape = 1, aes(alpha = .001), show.legend = F) +
  geom_smooth(size = 1.5, aes(fill = COD), method = 'loess') +
  # geom_line(data=logRSS.pop.model[var == 'boundary'& ttd=='1 day'], aes(x, rss, colour=COD)) +
