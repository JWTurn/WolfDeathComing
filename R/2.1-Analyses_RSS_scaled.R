...
# logRSS.indiv <- rbind(logRSS.CDV.nnclose.indiv, logRSS.human.nnclose.indiv, logRSS.control.nnclose.indiv,
#                       logRSS.CDV.packclose.indiv, logRSS.human.packclose.indiv, logRSS.control.packclose.indiv)
